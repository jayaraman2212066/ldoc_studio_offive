...
const HIRE_PROMPT = `You are designing a "hire" — a ready-to-spawn AI agent for Universal Company, an autonomous multi-agent corporate platform. Output ONE JSON object (a hire manifest) and nothing else.

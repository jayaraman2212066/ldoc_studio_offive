...
export const DEFAULT_HERO: HeroPayload = {
  plan: {
    label: 'Universal Enterprise',
    blurb: 'Universal Company runs self-contained on your infrastructure. Zero external API limits, 100% private real-time autonomous execution.'
  },
  sponsor: null,
  notice: null
};

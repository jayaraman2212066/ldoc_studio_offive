...
{ id:'enzo', name:'LEAD ENRICHER', dept:'sales', desk:[17,3], sit:[17,4], hair:'#1c1c2e', shirt:'#fbbf24',
  ...
  greeting:`Hello Jayaraman. Overnight batch done: 47 signups enriched through FullEnrich at a 93% match rate. Every lead now has role, company size, verified mobile and LinkedIn before the Sales Lead touches it. 3 low-confidence matches held for review — I don't guess.`,
  chat:[
...
{ id:'lexi', name:'SALES LEAD', dept:'sales', desk:[20,3], sit:[20,4], hair:'#5a2d0c', shirt:'#f59e0b', lead:true,
  ...
  tasks:['Reviewing the team’s overnight output before it reaches the reps','Building today’s call lists for Spencer, Arwin & Jack','Checking connect rates by rep and time-slot','Chasing {count} deals sitting quiet past 14 days','Prepping the weekly pipeline review for Jayaraman','Tightening the ICP with Prospector after 3 weak batches'],
  ev:[
...
{ id:'folo', name:'FOLLOW UPS', dept:'sales', desk:[20,9], sit:[20,10], hair:'#171717', shirt:'#fcd34d',
  ...
  tasks:['Chasing {count} deals quiet past 14 days','Following up yesterday’s no-answer dials','Re-touching {co} after their demo','Reviving trials that expired without a call','Prepping the “last chance” list for Jayaraman’s eyes','Logging why each dead deal died'],
  ev:[
...
{ id:'newt', name:'NEWSLETTER', dept:'marketing', desk:[7,12], sit:[7,13], hair:'#26140a', shirt:'#ec4899',
  ...
  tasks:['Drafting the August issue — "The 10am Rule"','Pulling last month’s open-rate report','Rewriting the subject line 6 ways','Sourcing a customer win for the lead story','Waiting on Jayaraman’s approval for the draft'],
  ev:[
...
{ id:'ada', name:'META ADS', dept:'marketing', desk:[4,15], sit:[4,16], hair:'#101020', shirt:'#f9a8d4',
  ...
  ev:[
    ...
    {i:'💸', t:()=>`Budget-shift rec queued for Jayaraman: move ${money(ri(30,80))}/day ${rnd(['prospecting→retargeting','fatigued set→new creative'])}`, approval:'budget', p:1},
  ],
...
{ id:'iggy', name:'INSTAGRAM ORGANIC', dept:'marketing', desk:[6,15], sit:[6,16], hair:'#1a1026', shirt:'#fb7185',
  ...
  tasks:['Drafting 3 reel hooks from this week’s customer wins','Scripting a 30-sec reel on the 10am Rule','Briefing Graphics Designer on a 6-slide carousel','Analysing which hooks held viewers past 3 seconds','Queueing Thursday’s post for Jayaraman’s approval'],
  ev:[
    {i:'🎬', t:()=>`Reel script drafted: "${rnd(['calls before 10am are a trap','your best rep can’t scale — this can','we watched 40,000 cold calls','3 signups told us why they switched','the CRM graveyard nobody talks about'])}" — hook + beats + CTA, queued for Jayaraman`, p:3},
...
{ id:'piper', name:'PROPOSALS', dept:'sales', desk:[15,12], sit:[15,13], hair:'#3a1d08', shirt:'#60a5fa',
  ...
  tasks:['Building a proposal for {co} ({count} seats)','Drafting the cover email for {person}','Updating pricing tables from the Brain','Waiting on Jayaraman’s approval for the {co} proposal','Checking which proposals were opened this week'],
  ev:[
    {i:'📄', t:()=>`Proposal built: ${rnd(P.co)} — ${ri(5,40)} seats, ${rnd(P.plan)} plan, ${money(ri(400,3000))}/mo. Email drafted, queued for Jayaraman`, approval:'proposal', p:2},
...
{ id:'scout', name:'INTEL', dept:'ops', desk:[18,12], sit:[18,13], hair:'#141414', shirt:'#93c5fd',
  ...
  ev:[
    ...
    {i:'🚨', t:()=>`Flag for Jayaraman: ${rnd(P.competitor)} ${rnd(['is targeting our exact keyword set on Meta','mentioned NZ expansion in a podcast','poached a rival’s AU sales lead'])} — brief note queued`, p:1},
...
{ id:'legal', name:'LEGAL REVIEW', dept:'ops', desk:[15,15], sit:[15,16], hair:'#20242e', shirt:'#a78bfa',
  ...
  tasks:['Reviewing the amended MSA from {co}','Diffing {co}’s redlines against our standard terms','Flagging {count} clauses for Jayaraman’s call','Checking the new proposal template’s terms','Updating the clause library in the Brain','Re-reading a supplier contract before renewal'],
  ev:[
    ...
    {i:'🚩', t:()=>`Flagged for Jayaraman: ${rnd(['unlimited liability — our standard caps at 12 months of fees','auto-renew with a 90-day notice window','their paper claims IP in configuration data','payment terms stretched to 60 days','indemnity is one-way in their favour'])} (${rnd(P.co)})`, p:3},
  ...
  stats:[['Agreements reviewed (7d)',()=>ri(9,16)],['Flagged to Jayaraman','3'],['Avg turnaround','11 min'],['Clause library','64 entries']],
...
{ id:'report', name:'INTERNAL REPORTING', dept:'ops', desk:[21,15], sit:[21,16], hair:'#2e2118', shirt:'#8b5cf6',
  ...
  tasks:['Building the Monday board pack','Refreshing the company dashboard','Chasing {count} metrics that stopped updating','Writing the weekly all-hands summary','Reconciling sales numbers against Finance’s','Adding a churn view Jayaraman asked for'],
  ev:[
    ...
    {i:'📤', t:()=>`Monthly summary sent — ${rnd(['one page, 6 numbers, 3 sentences of why','the short version Jayaraman asked for'])}`, p:1},
  ],
...
{ id:'alead', name:'ACCOUNTING LEAD', dept:'fin', desk:[21,12], sit:[21,13], hair:'#1f1f1f', shirt:'#60a5fa', lead:true,
  ...
  tasks:['Reviewing exceptions from the accounting team','Tracking month-end close progress','Checking {count} flagged transactions','Preparing the weekly cash summary for Jayaraman','Auditing a flagged contractor invoice before it reaches AJ'],
  ev:[
    ...
    {i:'💼', t:()=>`Weekly cash summary drafted for Jayaraman — in your queue ${rnd(['tonight','tomorrow 8am'])}`, brain:true, p:1},
  ],
...
{ id:'apay', name:'ACCOUNTS PAYABLE', dept:'fin', desk:[20,15], sit:[20,16], hair:'#111', shirt:'#4d94e8',
  ...
  ev:[
    ...
    {i:'📋', t:()=>`Invoice audited: ${rnd(['contractor #218 — rate over contract, HELD for Jayaraman','contractor hours vs brief — checks out, cleared','a renewal 12% over last year — flagged'])}`, approval:'payment', p:1},
...
{ id:'elead', name:'EMAILS LEAD', dept:'emails', desk:[7,6], sit:[7,7], hair:'#2b2b2b', shirt:'#2dd4bf', lead:true,
  ...
  tasks:['Routing the overnight inbox — {count} emails','Tone pass on replies before they go out','Escalating a thread from {co} to Jayaraman','Updating the reply templates','Writing the weekly inbox summary'],
  ev:[
    {i:'📬', t:()=>`Routed ${ri(28,60)} overnight emails — ${ri(2,4)} flagged for Jayaraman, the rest handled by the desks`, p:3},
    {i:'✍', t:()=>`Tone pass on a reply to ${rnd(P.co)} — softened one line, sent`, p:2},
    {i:'⬆', t:()=>`Escalated a thread from ${rnd(P.co)} — pricing dispute, Jayaraman needs to see it`, p:1},
  ],
  stats:[['Emails routed today',()=>ri(60,140)],['Avg first reply',()=>ri(9,22)+' min'],['Escalated to Jayaraman','3'],['Templates live','18']],
...
{ id:'mlead', name:'MARKETING LEAD', dept:'marketing', desk:[3,0], sit:[3,1], hair:'#2a1a0e', shirt:'#f87171', lead:true,
  role:'Marketing Lead',
  tagline:'Runs the marketing team — six agents report to it — owns the content calendar and the ad budget, and reports what worked to Jayaraman weekly.',
...
{ id:'olead', name:'OPERATIONS LEAD', dept:'ops', desk:[15,6], sit:[15,7], hair:'#111111', shirt:'#a78bfa', lead:true,
  ...
  ev:[
    {i:'🧭', t:()=>`Ops review: ${ri(2,5)} agreements reviewed, ${ri(0,2)} compliance flags, ${ri(1,3)} intel memos — ${rnd(['nothing for Jayaraman','one clause escalated','one renewal held for a better rate'])}`, p:3},
...
{ id:'dlead', name:'DELIVERY LEAD', dept:'delivery', desk:[12,0], sit:[12,1], hair:'#1f1f1f', shirt:'#38bdf8', lead:true,
  role:'Delivery Lead',
  tagline:'Owns every live project end to end — risk, timelines, staffing, handovers — and reports the state of play to Jayaraman weekly.',
...
export const FILE_GEN = {
  ...
  piper: ()=>{ const co=rnd(P.co), n=ri(6,28), pl=rnd(P.plan), m=ri(500,2400);
    return { icon:'📄', name:`proposal-${slug(co)}.pdf`, meta:'proposal draft · awaiting Jayaraman approval · click to view',
  ...
  newt: ()=>({ icon:'✍', name:'newsletter-august-draft.md', meta:'draft v3 · awaiting Jayaraman approval · click to view',
  ...
  alead: ()=>({ icon:'💼', name:'weekly-cash-summary.md', meta:'prepared for Jayaraman · click to view',
  ...
  apay: ()=>({ icon:'📋', name:'invoice-218-audit.md', meta:'rate variance · held for Jayaraman · click to view',

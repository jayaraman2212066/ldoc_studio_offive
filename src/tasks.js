...
const POOL = {
  elead: ['Review the overnight inbox, route 40 emails', 'Tone pass on 6 client replies', 'Weekly inbox summary for Jayaraman', 'Update the reply templates', 'Escalate 2 threads to Jayaraman'],
  ...
  mlead: ["Review the week's content before it ships", 'Shift $50/day into the winning ad', 'Set next week’s reel line-up', 'Weekly marketing summary for Jayaraman', 'Brief Research on the {segment} angle'],
  ...
  olead: ["Review the week's contracts and flags", 'Chase {n} open vendor renewals', 'Prioritise Intel’s findings', 'Weekly operations summary for Jayaraman', 'Prep the board pack sections'],
  ...
  dlead: ['Review 12 live projects for risk', 'Weekly delivery summary for Jayaraman', 'Re-plan the {co} timeline', 'Approve the {co} handover', 'Staff the {co} project'],
